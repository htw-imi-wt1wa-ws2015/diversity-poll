  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved value as @value" do
        post :create, {:value => invalid_attributes}, valid_session
        expect(assigns(:value)).to be_a_new(Value)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested value" do
        value = Value.create! valid_attributes
        put :update, {:id => value.to_param, :value => new_attributes}, valid_session
        value.reload
    ...
    context "with invalid params" do
      it "assigns the value as @value" do
        value = Value.create! valid_attributes
        put :update, {:id => value.to_param, :value => invalid_attributes}, valid_session
        expect(assigns(:value)).to eq(value)
      end
